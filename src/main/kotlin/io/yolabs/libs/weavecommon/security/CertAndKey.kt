...
object CertAndKey {
    ...
    fun readTLVCertFromBytes(byteArray: ByteArray): TLVCertificate {
        ...
        return readTLVCertFromTLV(structure)
    }

    fun readTLVCertFromTLV(structure: Structure): TLVCertificate {
...
//        val (r, s) = getSignatureRS(signature)
//        return Signature(Bytes(r), Bytes(s))
//    }
}
